...
public struct GLBufferBlock {
	...
	public let selector : GLAttributeSelector
	...
	*/
	public init (_ attribute: GLAttributeSelector, _ size: Int, _ type : Int32, _ normalized: Bool, _ stride: Int, _ offset: Int) {
